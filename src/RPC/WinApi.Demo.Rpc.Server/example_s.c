...
extern const MIDL_SERVER_INFO Example_ServerInfo;

extern const RPC_DISPATCH_TABLE Example_v1_0_DispatchTable;
...
RPC_IF_HANDLE Example_v1_0_s_ifspec = (RPC_IF_HANDLE)& Example___RpcServerInterface;
